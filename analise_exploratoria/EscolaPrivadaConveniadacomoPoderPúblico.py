...
# === CONFIGURAÇÃO ===
arquivo = "EscolaPrivadaConveniadacomoPoderPúblico.csv"
...
plt.title("Total de Matrículas por Escola Privada Conveniada com o Poder Público")
...
plt.title("Matrículas por Região e Escola Privada Conveniada com o PoderPúblico")
plt.xlabel("Região")
plt.ylabel("Total de Matrículas")
