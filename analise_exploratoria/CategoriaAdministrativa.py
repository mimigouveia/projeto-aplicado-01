...
# === CONFIGURAÇÃO ===
arquivo = "CategoriaAdministrativa.csv"
...
plt.title("Total de Matrículas por Categoria Administrativa")
...
plt.title("Matrículas por Região e Categoria Administrativa")
plt.xlabel("Região")
plt.ylabel("Total de Matrículas")
