...
# === CONFIGURAÇÃO ===
arquivo = "DependênciaAdministrativa.csv"
...
plt.title("Total de Matrículas por Dependência Administrativa")
...
plt.title("Matrículas por Região e Dependência Administrativa")
plt.xlabel("Região")
plt.ylabel("Total de Matrículas")
