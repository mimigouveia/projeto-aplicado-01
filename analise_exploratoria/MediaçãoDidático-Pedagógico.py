...
# === CONFIGURAÇÃO ===
arquivo = "MediaçãoDidático-Pedagógico.csv"
...
plt.title("Total de Matrículas por Mediação Didático-Pedagógico")
...
plt.title("Matrículas por Região e Mediação Didático-Pedagógico")
plt.xlabel("Região")
plt.ylabel("Total de Matrículas")
