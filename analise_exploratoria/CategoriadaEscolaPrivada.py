...
# === CONFIGURAÇÃO ===
arquivo = "CategoriadaEscolaPrivada.csv"
...
plt.title("Total de Matrículas por Categoria da Escola Privada")
...
plt.title("Matrículas por Região e Categoria da Escola Privada")
plt.xlabel("Região")
plt.ylabel("Total de Matrículas")
